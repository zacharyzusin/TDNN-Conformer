# Slightly modified by Zachary Zusin -- original code adapted from Mobvoi Inc's WeNet Framework
...
datadir=data/LibriSpeech # wav data dir
wave_data=data
data_type=raw
# Optional train_config
# 1. conf/train_transformer_large.yaml: Standard transformer
train_config=conf/train_tdnn.yaml
checkpoint=
num_workers=1
do_delta=false

dir=exp/tdnn_training
